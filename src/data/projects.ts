...
export const projects: Project[] = [
  ...
  // Project 39: Dr.Oracle — Mobile App — Images: /public/projects/DrOracle-Mobile/
  {
    id: 39,
    title: 'Dr.Oracle — Mobile App',
    subtitle: 'iOS & Android medical AI with guideline-backed, fully cited answers',
    description:
      'Native mobile experience for Dr.Oracle—the physician-owned medical AI adopted by hospital systems, residency programs, and universities. Available on iPhone, iPad, and Android, the app delivers evidence-based clinical support with in-text citations from official guidelines, PubMed literature, FDA drug labels, and case reports. Clinicians use it for differential diagnosis, guideline-directed management, and Research Mode literature synthesis across all subspecialties. Continuously reviewed by a multidisciplinary physician advisory board and fine-tuned weekly for accuracy.',
    image: '/projects/DrOracle-Mobile/screenshot-1.webp',
    images: [
      '/projects/DrOracle-Mobile/screenshot-1.webp',
      '/projects/DrOracle-Mobile/screenshot-2.webp',
      '/projects/DrOracle-Mobile/screenshot-3.webp',
      '/projects/DrOracle-Mobile/screenshot-4.webp',
    ],
    technologies: [
      'React Native',
      'TypeScript',
    ...
    features: [
      'Real-time medical Q&A with in-text citations from guidelines and peer-reviewed literature',
      'Research Mode to evaluate study strengths and weaknesses across clinical papers',
      'Differential diagnosis and guideline-directed treatment workflows on the go',
      'Coverage across all major medical subspecialties with exportable answers',
      'Unified subscription and conversation history backed by the shared Dr.Oracle API',
      'Optimized for iPhone, iPad, and Android with haptic feedback and offline-friendly UX',
    ],
    liveUrl:
      'https://apps.apple.com/us/app/dr-oracle-ai-medical-assistant/id6473809057',
    playStoreUrl:
      'https://play.google.com/store/apps/details?id=ai.thedeep.droracleandroid',
    githubUrl: '',
    category: ['AI/ML', 'Mobile'],
    gradient: 'from-sky-500 to-cyan-600',
  },
  // Project 40: Dr.Oracle — API & Backend — Images: /public/projects/DrOracle-Backend/
  {
    id: 40,
    title: 'Dr.Oracle — API & Backend',
    subtitle: 'Medical RAG platform powering clinical Q&A, Research Mode, and citations',
    description:
      'Backend and API tier for Dr.Oracle—the physician-owned medical AI powering the iOS and Android mobile apps. Ingests and indexes evidence from PubMed, international clinical guidelines, FDA drug labels, and case reports into a retrieval-augmented pipeline so every answer is grounded in citable sources. Orchestrates general medicine chat, Research Mode literature synthesis, differential diagnosis workflows, and guideline-directed management with streaming responses, in-text citations, and a physician advisory review queue. Handles mobile subscription billing (Apple IAP, Google Play), session auth, conversation history, and weekly model fine-tuning for accuracy.',
    image: '/projects/DrOracle-Backend/droracle-backend-diagram.png',
    images: ['/projects/DrOracle-Backend/droracle-backend-diagram.png'],
    technologies: [
      'Python',
      'FastAPI',
      'RAG',
    ...
    features: [
      'Medical knowledge ingestion from PubMed, guidelines, FDA labels, and case reports',
      'Hybrid retrieval and RAG orchestration for general medicine and Research Mode queries',
      'Citation engine with in-text source linking and fact-check / self-correction layer',
      'Differential diagnosis and guideline-directed treatment workflow endpoints',
      'Streaming chat API with conversation history for mobile clients',
      'Subscription, rate limiting, and physician advisory review pipeline',
    ],
    liveUrl: 'https://droracle.ai/',
    githubUrl: '',
    category: ['Backend', 'AI/ML'],
    gradient: 'from-blue-700 to-indigo-800',
  },
  // Project 34: ConvoCore — Images: /public/projects/ConvoCore/
  {
    id: 34,
    title: 'ConvoCore',
    subtitle: 'No-code AI voice & chat agent platform for businesses and agencies',
    description:
      'ConvoCore is an omnichannel AI agent platform for building, deploying, and white-labeling voice and chat assistants without code. Agencies and businesses use it to automate inbound calls, web chat, WhatsApp, Instagram, Messenger, Telegram, SMS, and email from a single visual flow builder. The platform orchestrates realtime voice stacks (Gemini Live, Grok AI Live, Ultravox, ElevenLabs), SIP trunking, knowledge-base ingestion, CRM/calendar integrations, and usage-based billing—with GDPR-compliant EU and US data regions and a full V3 REST API for custom deployments.',
    image: '/projects/ConvoCore/banner.png',
    images: ['/projects/ConvoCore/banner.png'],
    technologies: [
      'Node.js',
      'TypeScript',
      'REST API',
    ...
    features: [
      'Visual no-code flow builder with conditional routing, API calls, and human handoff',
      'AI voice agents on real phone numbers with ~700ms latency and SIP trunk support',
      'Omnichannel deployment: web chat, WhatsApp, Instagram, Messenger, Telegram, SMS, and voice',
      'Knowledge base ingestion from URLs, documents, FAQs, calendars, CRMs, and spreadsheets',
      'White-label agency mode with custom domains, branding, and unlimited client organizations',
      'V3 REST API, analytics dashboards, and 40+ integrations (Shopify, Make, n8n, and more)',
    ],
    liveUrl: 'https://convocore.ai/',
    githubUrl: '',
    category: ['AI/ML', 'full-stack'],
    gradient: 'from-violet-600 to-indigo-700',
  },
  // Project 35–38: AskYourPDF — Images: AskYourPdf-web/, Mobile/, Backend/, Extension/
  {
    id: 35,
    title: 'AskYourPDF — Web App',
    subtitle: 'PDF AI chat, document intelligence, and developer API platform',
    description:
      'Web platform for AskYourPDF—used by millions to chat with PDFs, summarize documents, manage libraries, autofill forms, and embed AI agents on websites. Built around RAG over uploaded files with multi-model support (GPT, Claude, Gemini), agent mode, source citation, and streaming responses. Includes a developer REST API, knowledge-base chat, Chrome extension, Zotero plugin, and ChatGPT plugin for document workflows in the browser.',
    image: '/projects/AskYourPdf-web/hero-section.mp4',
    images: [
      '/projects/AskYourPdf-web/logo.svg',
      '/projects/AskYourPdf-web/hero-section.mp4',
      '/projects/AskYourPdf-web/summarize.mp4',
      '/projects/AskYourPdf-web/documents.mp4',
    ],
    technologies: [
      'Python',
      'FastAPI',
    ...
    features: [
      'Chat with single or multiple PDFs with cited, context-aware answers',
      'Smart PDF autofill using paired source documents or pasted content',
      'Document library management with summaries and multi-document knowledge bases',
      'Embeddable AI agent widget for websites trained on custom documentation',
      'Developer REST API with agent mode, streaming, and multi-model selection',
      'Chrome extension and Zotero integration for browser and research workflows',
    ],
    liveUrl: 'https://askyourpdf.com/',
    githubUrl: '',
  ...
  {
    id: 36,
    title: 'AskYourPDF — Mobile App',
    subtitle: 'iOS & iPad PDF AI chat powered by Claude, ChatGPT & GPT-4',
    description:
      'Discover AskYourPDF powered by Claude, ChatGPT and GPT-4 APIs—not just a name, but a promise. Dive into a world where documents, be they PDFs, Word files, or other formats, come alive with conversation. Upload and engage in intelligent dialogues with our state-of-the-art AI chat. Extract not just data, but meaningful insights, answers, and knowledge from your files. Whether you\'re deciphering complex reports or simply curious about a paragraph\'s essence, AskYourPDF stands as your digital companion, ready to enlighten. It\'s not just document reading; it\'s a transformative experience of document interaction.',
    image: '/projects/AskYourPdf-Mobile/screenshot-1.webp',
    images: [
      '/projects/AskYourPdf-Mobile/screenshot-1.webp',
      '/projects/AskYourPdf-Mobile/screenshot-2.webp',
      '/projects/AskYourPdf-Mobile/screenshot-3.webp',
      '/projects/AskYourPdf-Mobile/screenshot-4.webp',
      '/projects/AskYourPdf-Mobile/screenshot-5.webp',
      '/projects/AskYourPdf-Mobile/screenshot-6.webp',
      '/projects/AskYourPdf-Mobile/screenshot-7.webp',
      '/projects/AskYourPdf-Mobile/screenshot-8.webp',
    ],
    technologies: [
      'React Native',
      'TypeScript',
    ...
    features: [
      'Chat with PDFs and documents with precise in-text citations',
      'Multi-document intelligence across several files in one conversation',
      'Summarization, literature review, and sources tools for academic work',
      'Document library and conversation management on mobile',
      'Unified subscription linking between web and mobile accounts',
      'Optimized performance for large files and multi-file sessions',
    ],
    liveUrl: 'https://apps.apple.com/app/askyourpdf-ai-chat-with-pdf/id6462732878',
    githubUrl: '',
    category: ['AI/ML', 'Mobile'],
  ...
  {
    id: 37,
    title: 'AskYourPDF — API & Backend',
    subtitle: 'Python / FastAPI RAG platform and developer API for document intelligence',
    description:
      'Backend and public API tier for AskYourPDF—the service that powers web, mobile, and third-party integrations. Handles document ingestion, chunking, vector embedding, and retrieval-augmented generation so chat answers stay grounded in uploaded PDFs and knowledge bases. Exposes REST endpoints for upload, single-document chat, multi-document knowledge-base chat, summarization, and streaming responses with API-key authentication. Orchestrates multiple LLM providers (OpenAI, Claude, Gemini), agent mode for higher-quality answers, source citation, and usage-based access for developer and product clients.',
    image: '/projects/AskYourPdf-Backend/askyourpdf-backend-diagram.png',
    images: ['/projects/AskYourPdf-Backend/askyourpdf-backend-diagram.png'],
    technologies: [
      'Python',
      'FastAPI',
      'RAG',
    ...
    features: [
      'Document upload, parsing, and chunking pipeline for PDF and text workflows',
      'Vector search and RAG retrieval with agent mode for higher-quality responses',
      'Chat endpoints for single documents and multi-document knowledge bases',
      'Streaming and citation-aware answers with multi-model routing (GPT, Claude, Gemini)',
      'Developer API with API-key auth, rate limits, and public documentation',
      'Shared backend for web app, mobile clients, Chrome extension, and embeddable agents',
    ],
    liveUrl: 'https://askyourpdf.com/developers',
    githubUrl: '',
    category: ['Backend', 'AI/ML'],
  ...
  {
    id: 38,
    title: 'AskYourPDF — Chrome Extension',
    subtitle: 'ChatPDF extension for in-browser PDF AI chat and summaries',
    description:
      'Chrome extension for AskYourPDF—the ChatPDF extension that lets you chat with PDFs, get summaries, ask questions, and receive answers without leaving the browser. Upload PDFs and engage with intelligent AI to extract insights from documents for faster research and decision-making. With advanced AI, the extension understands queries and returns accurate, concise answers so you are not just reading a document—you are having a conversation with it. Published on the Chrome Web Store with 20,000+ users and a 4.5-star rating.',
    image: 'https://www.youtube.com/watch?v=AAtRaoSNAaI',
    images: [
      'https://www.youtube.com/watch?v=AAtRaoSNAaI',
      '/projects/AskYourPdf-Extension/logo.svg',
    ],
    technologies: [
      'Chrome Extension',
      'Manifest V3',
    ...
    features: [
      'Chat with any PDF directly in Chrome with AI-powered Q&A',
      'Upload documents and get summaries without leaving the browser',
      'Accurate, concise answers grounded in document content',
      'Workflow & planning extension integrated with AskYourPDF accounts',
      'In-app purchases and subscription support via Chrome Web Store',
      'Continuous updates for performance and response accuracy',
    ],
    liveUrl: 'https://chromewebstore.google.com/detail/askyourpdf/gaieenaffioioljpcocdkpphlifbhaig',
    githubUrl: '',
    category: ['AI/ML', 'Frontend'],
